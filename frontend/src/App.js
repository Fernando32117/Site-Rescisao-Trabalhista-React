    ...
    <div className="App">
      ...
      >
        ...
        <label>
          ...
          >
            ...
            <option value="Não cumprido pelo empregador">
        ...
        <label>
          ...
          <input
            type="number"
            value={temFeriasVencidas ? feriasVencidas : ""}
            onChange={(e) => setFeriasVencidas(e.target.value)}
            disabled={!temFeriasVencidas}
          />
        </label>

        {/* **************CASO NECESSITE DESSE LABEL****************
          <label>  
          Saldo FGTS:  
      ...
      {resultado && !resultado.error && (
        <div className="resultado">
          ...
          <p>
            <strong>Salário Bruto:</strong> R$ {parseFloat(salario).toFixed(2)}
          </p>
          <p>
            <strong>Aviso Prévio:</strong> R$ {resultado.avisoPrevio}
          </p>
          <p>
            <strong>13º Salário Proporcional:</strong> R${" "}
          ...
          <p>
            <strong>Férias Vencidas:</strong> R$ {resultado.feriasVencidasValor}
          </p>
          <p>
            <strong>Saldo FGTS:</strong> R$ {resultado.fgtsSaldo}
          </p>{" "}
          {/* Correção aqui */}
          <p>
            <strong>Multa FGTS:</strong> R$ {resultado.multaFGTS}
          </p>
          <h3>
            <strong>Total a Receber:</strong> R$ {resultado.total}
          </h3>
        </div>
      )}
